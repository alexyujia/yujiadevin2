namespace Libra.Script {
	...
	export class Timer {
		...
		start(
			...
			assert_test(this.m_last_begin === null, `Libra.Script.Timer.start : timer already startd`);
		...
		stop(
			...
			assert_test(this.m_last_begin !== null, `Libra.Script.Timer.stop : timer not startd`);
