...
export module libra.shell.bridge.library;
import libra.shell.utility.library;
import libra.shell.bridge.service;
	...
	public:
		...
		explicit Library (
			...
			thiz.m_symbol = thiz.m_handle.lookup<Service>(
				...
				"?service@Interface@Kernel@Libra@@3UService@123@A"
				#endif
				#if defined M_system_linux || defined M_system_macintosh || defined M_system_android || defined M_system_iphone
				"_ZN5Libra6Kernel9Interface7serviceE"
				#endif
			);
